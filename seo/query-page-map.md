...
| basement renovation brantford | 316 | 1 | 18.44 | **Was not** the dedicated basement page. Homepage 262 impr/1 click/pos 13.74; `/pages/projects.html` 34 impr/pos 49.15; `/pages/project-full-basement-finish-brantford.html` 15 impr/pos 30.73; `/pages/services.html` 14 impr/pos 45.14; `/pages/bathroom-renovation-brantford.html` 7 impr/pos 38.86 | `/pages/basement-finishing-brantford.html` | **Root cause found and fixed 2026-08-13:** the page used "basement finishing" exclusively (36 mentions) and never once said "basement renovation" — in title, meta, H1, body copy, or any of the 10 internal links pointing to it site-wide. Fixed title/H1/meta/og/twitter/intro copy/Service schema name to include "renovation" alongside "finishing" (commit pending). Left "finishing" as primary term and didn't touch sitewide anchor text — see commit message for full rationale. |
